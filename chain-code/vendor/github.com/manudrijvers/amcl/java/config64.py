...
print(os.listdir(os.path.join(os.getcwd(), 'amcl')))
for file in [f for f in os.listdir(os.path.join(os.getcwd(), 'amcl')) if os.path.isfile(os.path.join('amcl', f))]:
	replace(os.path.join('amcl', file),"package amcl","package com.ibm.zurich.amcl")
	replace(os.path.join('amcl', file),"import amcl","import com.ibm.zurich.amcl")

for dir in [dir for dir in os.listdir('./amcl') if os.path.isdir(os.path.join('amcl', dir))]:
	for file in [f for f in os.listdir(os.path.join(os.getcwd(), 'amcl', dir)) if os.path.isfile(os.path.join('amcl', dir, f))]:
		replace(os.path.join('amcl', dir, file),"package amcl","package com.ibm.zurich.amcl")
		replace(os.path.join('amcl', dir, file),"import amcl","import com.ibm.zurich.amcl")